        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button 
              ...
              onClick={() => navigationService.navigateTo('smart-map')}
            >
            ...
            <Button 
              ...
              onClick={() => navigationService.navigateTo('eta')}
            >
              <div className="text-center">
            ...
            <Button 
              ...
              onClick={() => navigationService.navigateTo('crowd')}
            >
              <div className="text-center">
            ...
            <Button 
              ...
              onClick={() => navigationService.navigateTo('eco')}
            >
              <div className="text-center">
